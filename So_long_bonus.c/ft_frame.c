...
/*   Updated: 2024/04/19 17:22:17 by rohidalg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->frame <= 34)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pm1, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 40)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pm2, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 48)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pm3, (*j)
			* 60, (*i) * 60);
	else if (data->frame > 48)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pm4, (*j)
			* 60, (*i) * 60);
}
...
{
	if (data->frame <= 8)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pud, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 16)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pud1, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 24)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pud2, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 36)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pud3, (*j)
			* 60, (*i) * 60);
	else if (data->frame <= 52)
		mlx_put_image_to_window(data->mlx, data->win, data->images->pud4, (*j)
			* 60, (*i) * 60);
	else if (data->frame > 52)
	{
		data->frame = 0;
